    ...
    <div class="container-fluit">
        <div class="row">
            ...
            <div class="col-md-10 background1">
                <h1 class="background2">Thêm nhân viên</h1>
                    <?php 
...
<form action="" method="post" name="frmCreatehh" id="frmCreatehh" novalidate="true" onsubmit="return test()" enctype="multipart/form-data">
               ...
               <?php
                    if(isset($_POST['save'])){
                        $sdt_nv = $_POST['sdt_nv'];
                        $ten_nv = $_POST['ten_nv'];
                        $matkhau_nv = md5($_POST['matkhau_nv']);
                        ...
                        (sdt_nv, ten_nv, matkhau_nv, gioitinh_nv, email_nv, diachi_nv)
                        VALUES ('$sdt_nv', '$ten_nv', '$matkhau_nv', '$gioitinh_nv', '$email_nv', '$diachi_nv')
EOT;
...
function test(){
    ...
    if(check==true){
        ...
        alert("Thêm thông tin nhân viên không thành công, vui lòng kiểm tra lỗi của bạn");
    }
    return check;
