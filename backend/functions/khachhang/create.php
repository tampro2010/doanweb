    ...
    <div class="container-fluit">
        <div class="row">
            ...
            <div class="col-md-10 background1">
                <h1 class="background2">Thêm Khách hàng</h1>
                    <?php 
...
<form action="" method="post" name="frmCreatehh" id="frmCreatehh" novalidate="true" onsubmit="return test()" enctype="multipart/form-data">
               ...
               <?php
                    if(isset($_POST['save'])){
                        ...
                        (sdt_kh, ten_kh, matkhau_kh, gioitinh_kh, emai_kh, diachi_kh)
                        VALUES ('$sdt_kh', '$ten_kh', '$matkhau_kh', '$gioitinh_kh', '$emai_kh', '$diachi_kh')
EOT;
...
function test(){
    ...
    if(check==true){
        ...
        alert("Thêm thông tin khách hàng không thành công, vui lòng kiểm tra lỗi của bạn");
    }
    return check;
