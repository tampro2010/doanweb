    ...
    <div class="container-fluit">
        <div class="row">
            ...
            <div class="col-md-10 background1">
                <h1 class="background2">Thêm Khuyến mãi</h1>
                    <?php 
...
<form action="" method="post" name="frmCreatehh" id="frmCreatehh" novalidate="true" onsubmit="return test()" enctype="multipart/form-data">
               ...
               <div class="form-group">
                    <label for="apdung" style="margin-right: 20px;">Áp dụng</label>
               ...
               <?php
                    if(isset($_POST['save'])){
                        ...
                        (noidung_km, ngaybatdau_km, ngayketthuc_km, phantram, apdung)
                        VALUES ('$noidung_km', '$ngaybatdau_km', '$ngayketthuc_km', '$phantram','$apdung')
EOT;
...
function test(){
    ...
    if(check==true){
        alert("Thêm thông tin khuyến mãi thành công");
    }else{
        alert("Thêm thông tin khuyến mãi không thành công, vui lòng kiểm tra lỗi của bạn");
    }
    return check;
