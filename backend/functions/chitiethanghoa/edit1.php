...
<body>
    ...
    <div class="container-fluit background1" style="margin-left: 20px;">
        <div class="row">
            ...
            <div class="col-md-10">
                <h1 class="background3">Sửa chi tiết hàng hóa</h1>
                <!-- style="position: -webkit-sticky;position: sticky;top: 0;" -->
                <a href="edit2.php" class="btn btn-secondary" target="ifamCTHH">Điện thoại</a>
                <a href="edit3.php" class="btn btn-secondary" target="ifamCTHH">Laptop</a>
                <a href="index1.php" class="btn btn-secondary" style="margin-left: 750px;">
                Xem danh sách
                </a>
                <iframe src="edit2.php" frameborder="0" name="ifamCTHH" width="100%" height="800px"></iframe>
            </div>
